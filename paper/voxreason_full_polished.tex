...
\newcommand{\repo}{\url{https://github.com/MENGZHEGENG/voxreason}}
...
\author{\textbf{Mengzhe Geng}\\
National Research Council Canada\\
\texttt{Mengzhe.Geng@nrc-cnrc.gc.ca}}
\date{}

% The final-copy switch keeps the author block and suppresses ICLR line numbers.
\iclrfinalcopy
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{figures/revisions/pre_synthesis_schematic_ledger_split/pre_synthesis_evidence_path_polished3.pdf}
...
\input{tables/evidence_sensitivity_table.tex}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{figures/revisions/evidence_sensitivity_results/evidence_sensitivity_results.pdf}
