...
\begin{itemize}
    ...
    \item empirical diagnostics showing that evidence-grounded planning closes large gaps against a text-only control while model-scale and preference variants reveal remaining plan-coverage weaknesses.
\end{itemize}
